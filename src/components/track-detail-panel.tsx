...
import { X, Clock, FileType } from "lucide-react";
...
export default function TrackDetailPanel() {
  ...
  if (!currentTrack) {
    return (
      <div className="h-full flex flex-col rounded-lg outline outline-border w-full p-6 bg-popover/50 backdrop-blur-xl items-center justify-center text-muted-foreground">
  ...
  return (
    <div
      id="track-detail-panel"
      className="h-full flex flex-col rounded-lg outline outline-border w-full bg-popover/50 backdrop-blur-xl overflow-hidden"
    >
      <div className="flex justify-between items-center p-3 pl-4 shrink-0 mb-2">
