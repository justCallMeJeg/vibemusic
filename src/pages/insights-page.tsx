...
const InsightsContentSkeleton = memo(function InsightsContentSkeleton({ isPlayerVisible }: { isPlayerVisible: boolean }) {
  return (
    <div className={cn("space-y-6 animate-pulse", isPlayerVisible ? "pb-player-bar" : "pb-8")}>
      <div className="px-4">
...
export default memo(function InsightsPage() {
  ...
  const isEmpty =
    data ? (data.total_listening_ms === 0 && data.top_tracks.length === 0) : false;
    ...
    <PageLayout overflowHidden>
      <div className="flex flex-col shrink-0">
        <PageHeader title="Insights">
          <TimeRangeSelector value={timeRange} onChange={setTimeRange} disabled={!data} />
        </PageHeader>
      </div>
      ...
      >
        {!data ? (
          <InsightsContentSkeleton isPlayerVisible={isPlayerVisible} />
        ) : isEmpty ? (
          <div className="p-8">
            <EmptyState
              icon={BarChart2}
          ...
          <div className="space-y-6">
            {/* Overview — dynamic based on timeRange */}
